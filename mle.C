...
void chisquare(int ifile = 0,int itrig = 0,int ipt = 0,int iframe = 0,int xsect = 11,int ysect = 11){
	...
	chi2[ifile][itrig][ipt][iframe] = new TH2F(Form("chi2_%d_%d_%d_%d",ifile,itrig,ipt,iframe),"MLE;#lambda_{#theta};#lambda_{#phi}",CHIXBIN,-1,1,CHIYBIN,-1,1);
		...
		for(int ynbin=ysect;ynbin<ysect+10;ynbin++){
			...
			for(int xbin=1;xbin<XNBIN+1;xbin++){
				for(int ybin=1;ybin<YNBIN+1;ybin++){
					...
					//					if(rawdata->GetBinError(xbin,ybin)<1e-4) continue;
			...
			chi2[ifile][itrig][ipt][iframe]->Fill(lambda1,lambda2,likelihood);
...
cout<<"chi2 ="<<chi2[ifile][itrig][ipt][iframe]<<endl;

xbin = chi2[ifile][itrig][ipt][iframe]->GetXaxis()->FindBin(lambda[0][0]);
ybin = chi2[ifile][itrig][ipt][iframe]->GetYaxis()->FindBin(lambda[1][0]);

gradient[0] = (chi2[ifile][itrig][ipt][iframe]->GetBinContent(xbin+1,ybin)-chi2[ifile][itrig][ipt][iframe]->GetBinContent(xbin,ybin))/delta;
gradient[1] = (chi2[ifile][itrig][ipt][iframe]->GetBinContent(xbin,ybin+1)-chi2[ifile][itrig][ipt][iframe]->GetBinContent(xbin,ybin))/delta;

Hessian[0][0] = (chi2[ifile][itrig][ipt][iframe]->GetBinContent(xbin+1,ybin)-2*chi2[ifile][itrig][ipt][iframe]->GetBinContent(xbin,ybin)+chi2[ifile][itrig][ipt][iframe]->GetBinContent(xbin-1,ybin))/(delta*delta);
Hessian[1][1] = (chi2[ifile][itrig][ipt][iframe]->GetBinContent(xbin,ybin+1)-2*chi2[ifile][itrig][ipt][iframe]->GetBinContent(xbin,ybin)+chi2[ifile][itrig][ipt][iframe]->GetBinContent(xbin,ybin-1))/(delta*delta);
Hessian[0][1] = Hessian[1][0] = (chi2[ifile][itrig][ipt][iframe]->GetBinContent(xbin+1,ybin+1) + chi2[ifile][itrig][ipt][iframe]->GetBinContent(xbin,ybin) - chi2[ifile][itrig][ipt][iframe]->GetBinContent(xbin+1,ybin) - chi2[ifile][itrig][ipt][iframe]->GetBinContent(xbin,ybin+1))/(delta*delta);
...
cout<<"min x bin = "<< chi2[ifile][itrig][ipt][iframe]->GetXaxis()->FindBin(lambda[0][0])<<"min y bin ="<<chi2[ifile][itrig][ipt][iframe]->GetYaxis()->FindBin(lambda[1][0])<<endl;
if(chi2[ifile][itrig][ipt][iframe]->GetXaxis()->FindBin(lambda[0][0])==chi2[ifile][itrig][ipt][iframe]->GetXaxis()->FindBin(lambda[0][1]) && chi2[ifile][itrig][ipt][iframe]->GetYaxis()->FindBin(lambda[1][0])==chi2[ifile][itrig][ipt][iframe]->GetYaxis()->FindBin(lambda[1][1])) {
cout<<"min x bin = "<< chi2[ifile][itrig][ipt][iframe]->GetXaxis()->FindBin(lambda[0][0])<<"min y bin ="<<chi2[ifile][itrig][ipt][iframe]->GetYaxis()->FindBin(lambda[1][0])<<endl;
break;
}
else{
