...
void fitlambda(int file = 0, int trig = 0, int pt = 0, int frame = 0){
	...
	mlefcn = new TF2("mlefcn","[0]+[1]*x+[2]*y+[3]*x*x+[4]*x*y+[5]*y*y+[6]*x*x*x+[7]*x*x*y+[8]*x*y*y+[9]*y*y*y+[10]*x*x*x*x+[11]*x*x*x*y+[12]*x*x*y*y+[13]*x*y*y*y+[14]*y*y*y*y+[15]*x*x*x*x*x+[16]*x*x*x*x*y+[17]*x*x*x*y*y+[18]*x*x*y*y*y+[19]*x*y*y*y*y+[20]*y*y*y*y*y+[21]*x*x*x*x*x*x+[22]*x*x*x*x*x*y+[23]*x*x*x*x*y*y+[24]*x*x*x*y*y*y+[25]*x*x*y*y*y*y+[26]*x*y*y*y*y*y+[27]*y*y*y*y*y*y+[28]*x*x*x*x*x*x*x+[29]*y*x*x*x*x*x*x+[30]*y*y*x*x*x*x*x+[31]*y*y*y*x*x*x*x+[32]*x*x*x*y*y*y*y+[34]*x*x*y*y*y*y+[35]*x*y*y*y*y*y+[36]*y*y*y*y*y*y*y+[37]*x*x*x*x*x*x*x*x+[38]*y*x*x*x*x*x*x*x+[39]*y*y*x*x*x*x*x*x+[40]*y*y*y*x*x*x*x*x+[41]*y*y*y*y*x*x*x*x+[42]*x*x*x*y*y*y*y*y+[43]*x*x*y*y*y*y*y*y+[44]*x*y*y*y*y*y*y*y+[45]*y*y*y*y*y*y*y*y",-1,1,-1,1);
	//	TF2* mlefcn = new TF2("mlefcn","[0]+[1]*x+[2]*y+[3]*x*x+[4]*x*y+[5]*y*y+[6]*x*x*x+[7]*x*x*y+[8]*x*y*y+[9]*y*y*y",-1,1,-1,1);
	...
	//minimization(file,trig,pt,frame);
	...
	contour[1] = minimum + 2;
	mlefcn->SetContour(2,contour);

//	TBox *minpoint = new TBox(xx-0.02,yy-0.02,xx+0.02,yy+0.02);
...
//	minpoint->SetLineColor(kRed);
	...
	contfcn = new TF2("contfcn","[0]+[1]*x+[2]*y+[3]*x*x+[4]*x*y+[5]*y*y+[6]*x*x*x+[7]*x*x*y+[8]*x*y*y+[9]*y*y*y+[10]*x*x*x*x+[11]*x*x*x*y+[12]*x*x*y*y+[13]*x*y*y*y+[14]*y*y*y*y+[15]*x*x*x*x*x+[16]*x*x*x*x*y+[17]*x*x*x*y*y+[18]*x*x*y*y*y+[19]*x*y*y*y*y+[20]*y*y*y*y*y+[21]*x*x*x*x*x*x+[22]*x*x*x*x*x*y+[23]*x*x*x*x*y*y+[24]*x*x*x*y*y*y+[25]*x*x*y*y*y*y+[26]*x*y*y*y*y*y+[27]*y*y*y*y*y*y+[28]*x*x*x*x*x*x*x+[29]*y*x*x*x*x*x*x+[30]*y*y*x*x*x*x*x+[31]*y*y*y*x*x*x*x+[32]*x*x*x*y*y*y*y+[34]*x*x*y*y*y*y+[35]*x*y*y*y*y*y+[36]*y*y*y*y*y*y*y+[37]*x*x*x*x*x*x*x*x+[38]*y*x*x*x*x*x*x*x+[39]*y*y*x*x*x*x*x*x+[40]*y*y*y*x*x*x*x*x+[41]*y*y*y*y*x*x*x*x+[42]*x*x*x*y*y*y*y*y+[43]*x*x*y*y*y*y*y*y+[44]*x*y*y*y*y*y*y*y+[45]*y*y*y*y*y*y*y*y",xmin,xmax,ymin,ymax);
	chi2->Fit("contfcn","Q0");
	...
	TH2F* difference = new TH2F("difference","difference;#lambda_{#theta};#lambda_{#phi}",100,-1,1,100,-1,1);
	for(int i=1;i<101;i++){
		for(int j=1;j<101;j++){
			double chi2_x = difference->GetXaxis()->GetBinCenter(i);
			double chi2_y = difference->GetYaxis()->GetBinCenter(j);
			double difference_xy = chi2->GetBinContent(i,j)-contfcn->Eval(chi2_x,chi2_y);
			difference->SetBinContent(i,j,difference_xy);
		}
	}		
	difference->SetMaximum(1);
	difference->SetMinimum(-1);
	...
	for(int i=1;i<101;i++){
		for(int j=1;j<101;j++){
			double chi2_x = difference->GetXaxis()->GetBinCenter(i);
			double chi2_y = difference->GetYaxis()->GetBinCenter(j);
			double ratio_xy = chi2->GetBinContent(i,j)/mlefcn->Eval(chi2_x,chi2_y);
	...
	canvas[file][trig][pt][frame]->SaveAs(Form("~/polresults/20160707/pdf/sys_%d/mle_%d_%d_%d_%d.pdf",file,file,trig,pt,frame));
	inputfile->Close();	
}
